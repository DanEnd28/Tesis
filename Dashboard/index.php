...
if ($_POST) {
    ...
    $login = "SELECT usuario.Cedula,usuario.Usuario, usuario.Contraseña, usuario_rol.Rol_id, rol.Desc_rol FROM usuario INNER JOIN usuario_rol on usuario.Cedula=usuario_rol.Cedula INNER JOIN rol on usuario_rol.Id_Rol=rol.Rol_id where usuario.Usuario='$usuario'";
    ...
    if ($num > 0) {
        ...
        $password_bd = $row['usuario.Contraseña'];
...
<body class="bg-gradient-primary">
    ...
    <script src="../Librerias/JqueryValidate/formulario_jquery.js"></script>
</body>
